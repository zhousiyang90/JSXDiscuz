//
//  CommunityDetailViewController_dynamic.m
//  JSXDiscuz
//
...
@interface CommunityDetailViewController_dynamic ()<UITableViewDelegate,UITableViewDataSource>
{
    BOOL hasNewData;
}
...
@implementation CommunityDetailViewController_dynamic
