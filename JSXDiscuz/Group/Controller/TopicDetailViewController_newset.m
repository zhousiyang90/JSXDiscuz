//
//  TopicDetailViewController_newset.m
//  JSXDiscuz
//
...
@interface TopicDetailViewController_newset ()<UITableViewDelegate,UITableViewDataSource>
{
    BOOL hasNewData;
}
...
@implementation TopicDetailViewController_newset
