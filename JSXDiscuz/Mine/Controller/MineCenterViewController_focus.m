//
//  MineCenterViewController_focus.m
//  JSXDiscuz
//
...
@interface MineCenterViewController_focus ()<UITableViewDelegate,UITableViewDataSource>
{
    BOOL hasNewData;
}
...
@implementation MineCenterViewController_focus
