//
//  MineCenterViewController_mine.m
//  JSXDiscuz
//
...
@interface MineCenterViewController_mine ()<UITableViewDelegate,UITableViewDataSource>
{
    BOOL hasNewData;
}
...
@implementation MineCenterViewController_mine
