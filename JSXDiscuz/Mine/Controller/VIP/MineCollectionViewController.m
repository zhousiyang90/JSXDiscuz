...
{
    CGFloat autoHeight = [tableView fd_heightForCellWithIdentifier:@"mineCollectionTableViewCell" cacheByIndexPath:indexPath configuration:^(id cell) {
...
{
    MineCollectionTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"mineCollectionTableViewCell"];
...
-(void)configCell:(MineCollectionTableViewCell*)cell andIndexPath:(NSIndexPath*)indexpath
{
...
-(void)addSubViews
{
    [self.tableview registerNib:[UINib nibWithNibName:@"MineCollectionTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"mineCollectionTableViewCell"];
